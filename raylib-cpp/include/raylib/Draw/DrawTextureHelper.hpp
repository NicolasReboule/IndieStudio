...
namespace raylib {
    /**
     * @brief Texture drawing functions
     */
    ...
    public:
         ...
         */
        static void drawTexture(const RlTexture &texture, int posX, int posY, const RlColor &tint);
         ...
         * @param tint the color tint of the texture
         */
        static void drawTexture(const RlTexture &texture, const Vector2f &position, const RlColor &tint);
         ...
         * @param tint the color tint of the texture
         */
        static void drawTexture(const RlTexture &texture, const Vector2f &position, float rotation, float scale, const RlColor &tint);
         ...
         * @param tint the color tint of the texture
         */
        static void drawTextureRec(const RlTexture &texture, const Rectangle &source, const Vector2f &position, const RlColor &tint);
         ...
         * @param tint the color tint of the texture
         */
        static void drawTextureQuad(const RlTexture &texture, const Vector2f &tiling, const Vector2f &offset, const Rectangle &quad, const RlColor &tint);
         ...
         * @param tint the color tint of the texture
         */
        static void drawTextureTiled(const RlTexture &texture, const Rectangle &source, const Rectangle &dest, const Vector2f &origin, float rotation, float scale, const RlColor &tint);
         ...
         * @param tint the color tint of the texture
         */
        static void drawTexture(const RlTexture &texture, const Rectangle &source, const Rectangle &dest, const Vector2f &origin, float rotation, const RlColor &tint);
         ...
         * @param tint the color tint of the texture
         */
        static void drawTextureNPatch(const RlTexture &texture, const NPatchInfo &nPatchInfo, const Rectangle &dest, const Vector2f &origin, float rotation, const RlColor &tint);
         ...
         */
        static void drawTexturePoly(const RlTexture &texture, const Vector2f &center, const std::vector<Vector2f> &points, std::vector<Vector2f> &texcoords, const RlColor &tint);
    };
}
