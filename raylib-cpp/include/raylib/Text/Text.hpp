...
namespace raylib {
    ...
    public:
        ...
        void drawFPS(int posX, int posY);                                                               // DrawHelper current FPS
        static void drawText(const std::string &text, int posX, int posY, int fontSize, Color color);                 // DrawHelper text (using default font)
        void drawTextEx(Font font, const std::string &text, Vector2 position, float fontSize, float spacing, Color tint);  // DrawHelper text using font and additional parameters
        void drawTextPro(Font font, const std::string &text, Vector2 position, Vector2 origin, float rotation, float fontSize, float spacing, Color tint); // DrawHelper text using Font and pro parameters (rotation)
        void drawTextCodepoint(Font font, int codepoint, Vector2 position, float fontSize, Color tint); // DrawHelper one character (codepoint)
