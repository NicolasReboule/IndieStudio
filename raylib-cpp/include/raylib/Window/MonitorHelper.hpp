...
namespace raylib {
    ...
    public:
        ...
        Vector2f getMonitorPosition(int monitor);                                // Get specified monitor position
        ...
        Vector2f getWindowPosition();                                        // Get window position XY on monitor
        Vector2f getWindowScaleDPI();                                        // Get window scale DPI factor
