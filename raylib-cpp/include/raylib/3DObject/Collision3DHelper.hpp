...
namespace raylib::helper {
    ...
    public:
         ...
         */
        static RayCollision getRayCollisionModel(Ray ray, model::RlModel model);
         ...
         */
        static RayCollision getRayCollisionMesh(Ray ray, model::RlMesh mesh, Matrix transform);
