...
void raylib::model::RlModel::setPosition(Vector3f position)
{
...
void raylib::model::RlModel::setPosition(float x, float y, float z)
{
    _position.x = x;
    _position.y = y;
    _position.z = z;
...
void raylib::model::RlModel::setScale(float x, float y, float z)
{
    this->_scale.x = x;
    this->_scale.y = y;
    this->_scale.z = z;
...
void raylib::model::RlModel::setScale(Vector3f scale)
{
    this->_scale = scale;
...
void raylib::model::RlModel::setRotationAxis(Vector3f rotationAxis)
{
    _rotationAxis = rotationAxis;
}

void raylib::model::RlModel::setRotationAxis(float x, float y, float z)
{
    _rotationAxis.x = x;
    _rotationAxis.y = y;
    _rotationAxis.z = z;
