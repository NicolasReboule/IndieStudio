...
raylib::image::RlImage raylib::helper::ImageHelper::loadRaw(const std::string &fileName, int width, int height, int format, int headerSize)
{
...
raylib::image::RlImage raylib::helper::ImageHelper::loadFromMemory(const std::string &fileType, const unsigned char *fileData, int dataSize)
{
...
raylib::image::RlImage raylib::helper::ImageHelper::fromText(const std::string &text, int fontSize, const RlColor &color)
{
    return raylib::image::RlImage(ImageText(text.c_str(), fontSize, color.getColor()));
}

raylib::image::RlImage raylib::helper::ImageHelper::fromText(const raylib::text::RlFont &font, const std::string &text, float fontSize, float spacing, const RlColor &tint)
{
    return raylib::image::RlImage(ImageTextEx(font.getFont(), text.c_str(), fontSize, spacing, tint.getColor()));
}

raylib::image::RlImage raylib::helper::ImageHelper::genImageFontAtlas(const GlyphInfo *chars, Rectangle **recs, int glyphCount, int fontSize, int padding, int packMethod)
{
