...
bool raylib::helper::Collision2DHelper::checkCollisionRecs(const Rectangle &rec1, const Rectangle &rec2)
{
    return CheckCollisionRecs(rec1, rec2);
}

bool raylib::helper::Collision2DHelper::checkCollisionCircles(const Vector2f &center1, const float &radius1, const Vector2f &center2, const float &radius2)
{
...
bool raylib::helper::Collision2DHelper::checkCollisionCircleRec(const Vector2f &center, const float &radius, const Rectangle &rec)
{
    return CheckCollisionCircleRec(raylib::helper::VectorHelper::toRaylibVector(center), radius, rec);
}

bool raylib::helper::Collision2DHelper::checkCollisionPointRec(const Vector2f &point, const Rectangle &rec)
{
    return CheckCollisionPointRec(raylib::helper::VectorHelper::toRaylibVector(point), rec);
}

bool raylib::helper::Collision2DHelper::checkCollisionPointCircle(const Vector2f &point, const Vector2f &center, const float &radius)
{
...
bool raylib::helper::Collision2DHelper::checkCollisionPointTriangle(const Vector2f &point, const Vector2f &p1, const Vector2f &p2, const Vector2f &p3)
{
...
bool raylib::helper::Collision2DHelper::checkCollisionLines(const Vector2f &startPos1, const Vector2f &endPos1,
...
bool raylib::helper::Collision2DHelper::checkCollisionPointLine(const Vector2f &point, const Vector2f &p1, const Vector2f &p2, const int &threshold)
{
...
Rectangle raylib::helper::Collision2DHelper::getCollisionRec(const Rectangle &rec1, const Rectangle &rec2)
{
