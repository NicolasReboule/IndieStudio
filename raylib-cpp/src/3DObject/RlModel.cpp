...
//
raylib::RlModel::RlModel(const raylib::RlMeshBuilder &mesh, const std::string &texturePath, Vector3f position, Vector3f scale, Color color, Vector3f rotationAxis, float rotationAngle)
