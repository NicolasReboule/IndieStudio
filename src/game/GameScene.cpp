...
void Indie::GameScene::sceneLauncher()
{
    ...
    for (int i = 0;  i < 7; i++, index++) {
        auto wall = std::make_shared<Indie::Wall>("wall" + std::to_string(index), raylib::builder::RlMeshBuilder::MeshCube, "./assets/bricks.png");
    ...
    for (int i = 1;  i < 3; i ++, index++) {
        auto wallDestroyable = std::make_shared<Indie::WallDestroyable>("wallDestoyable" + std::to_string(index), raylib::builder::RlMeshBuilder::MeshCube, "./assets/blackston.png");
